...
function lib_arclist( &$ctag, &$refObj )
{
    ...
    //TODO modify 是否每个栏目只显示一条
    $onearctype = $ctag->GetAtt('onearctype');
    ...
    return lib_arclistDone
           (
             ...
             $tagid,$pagesize,$isweight,$onearctype
           );
}
 ...
 * @param     string  $onearctype 是否每个栏目里面只需要一条文章
 * @return    string
 */
function lib_arclistDone(&$refObj, &$ctag, $typeid=0, $row=10, $col=1, $titlelen=30, $infolen=160,
        $imgwidth=120, $imgheight=90, $listtype='all', $orderby='default', $keyword='',
        $innertext='', $arcid=0, $idlist='', $channelid=0, $limit='', $att='', $order='desc', $subday=0, $noflag='',$tagid='', $pagesize=0, $isweight='N',$onearctype='N')
{
    ...
    if($idlist=='')
    {
        ...
        //TODO　modify
        if($onearctype =='Y') $orwheres[] = ' arc.id IN (SELECT max(id) FROM #@__archives GROUP BY typeid) ';
    }   
